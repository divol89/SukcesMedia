...
const createWindow = (windowName, options) => {
  ...
  const win = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow(_objectSpread(_objectSpread(_objectSpread({}, state), options), {}, {
    webPreferences: _objectSpread(_objectSpread({}, options.webPreferences), {}, {
